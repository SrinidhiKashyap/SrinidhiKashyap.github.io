export function ContactInfoPanel() {
  return (
    <section className="contact-panel">
      ...
      <p className="mt-4 text-base text-white/80 md:mt-6 md:text-lg">
        For general enquiries, fill out the form to get in touch.
      </p>
      ...
      <address className="mt-8 space-y-3 text-base text-white/90 not-italic md:mt-10 md:space-y-4 md:text-lg">
        ...
        <p>
          Email:{" "}
          <a
            className="hover:underline touch-target tap-highlight-transparent"
            href="mailto:hellobeeconcept@gmail.com"
          >
