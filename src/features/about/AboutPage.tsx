    ...
    <PageLayout>
      <main className="bg-[#181818] text-white">
        <section className="px-section-x-sm py-10 sm:px-section-x-md sm:py-14 lg:px-section-x-lg lg:py-20">
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.1fr_0.8fr] lg:items-center lg:gap-20">
            <div>
              <p className="text-section-label font-medium"><span aria-hidden>&bull;</span> About Us</p>
              <h1 className="mt-7 max-w-3xl text-heading-lg font-semibold">
                We blend creativity with strategy to deliver standout designs that inspire and achieve remarkable results
              </h1>
              <div className="mt-8 max-w-2xl space-y-6 text-copy-lg text-white/90">
                <p>We are Branding, web Design Agency based in Hublli specializing in Ui/Ux, and Web Development.</p>
                <p>With over 8 years of experience, Bee concept is an energetic, fresh and passionate team offering creativity and industry knowledge.</p>
                <p>As passionate storytellers, we blend design and strategy to accelerate brands across diverse industries. With a fresh perspective and a deep love for our craft, we turn ideas into impactful narratives that truly resonate.</p>
              </div>
            </div>
        ...
        <section className="grid min-h-[440px] grid-cols-2 bg-[#303030]" aria-label="Bee Concept showreel">
        ...
        <section className="bg-[#242424] px-section-x-sm py-16 sm:px-section-x-md lg:px-section-x-lg lg:py-24">
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.85fr_1fr] lg:items-center lg:gap-20">
            <div>
